...
Param (
    ...
    [guid]$RootGuid = '99017c92-23c8-4461-b56b-cfffe88a040d'
)
...
Begin {
    ...
    Add-Type -TypeDefinition $LogosUtility -ErrorAction Stop
...
Process {
    [Logos.Utility.GuidUtility]::Create($RootGuid, $ApiName, $HashMap.$Hash)
}